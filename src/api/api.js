...
export default {
  ...
  // 绑定手机号码
  bind(params) {
    return ask.askPost(baseApiUrl + "/api/account/bind/", params);
  },
  // 获取验证码
  send(params) {
  ...
  //   return ask.askPost(baseApiUrl + "/api/recruitments/{id}/", params);
  // },
  // 立即报名
  // renrollment (params) {
  //   return ask.askPost(baseApiUrl + "/api/recruitments/{id}/enrollment/", params);
  // },
  // 取消报名
  // renrollment (params) {
  //   return ask.askPost(baseApiUrl + "/api/recruitments/{id}/enrollment/", params);
  ...
  // 收藏
  // favorite (params) {
  //   return ask.askPost(baseApiUrl + "/api/recruitments/{id}/favorite/", params);
  // },
  // 取消收藏
  // favorite (params) {
  //   return ask.askPost(baseApiUrl + "/api/recruitments/{id}/favorite/", params);
